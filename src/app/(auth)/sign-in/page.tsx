        ...
        <Card className="p-8 bg-white/95 backdrop-blur-luxury shadow-luxury-lg">
          <div className="text-center mb-8">
            ...
            <Typography variant="body" className="text-gray-600">
              Sign in to your executive command center
            </Typography>
          </div>
          ...
          <div className="mt-6 text-center space-y-2">
            <Link
              ...
              className="text-sm text-navy hover:text-navy-600 transition-colors"
            >
              Forgot your password?
            </Link>
            <div className="text-sm text-gray-600">
              Don't have an account?{' '}
              <Link href="/auth/signup" className="text-navy hover:text-navy-600 font-medium">
                Sign up
              </Link>
            </div>
          </div>
